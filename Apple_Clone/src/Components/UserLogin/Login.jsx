  ...
  const handleLogin = async (imageData) => {
    try {
      ...
      if (response.data.success) {
        ...
        setMessage(response.data.error || 'Authentication failed. Please try again.');
      }
    } catch (error) {
      console.error('Login error:', error);
      setMessage(error.response?.data?.error || error.message || 'Authentication failed. Please try again.');
    } finally {
